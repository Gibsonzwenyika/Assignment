...
public class Main {
    public static void main(String[] args) {
        try {
            CompilationUnit cu = StaticJavaParser.parse(new File("C:\\Users\\tembo\\Desktop\\GPACALCULATOR\\GPACALCULATOR\\projectAnalyzer\\src\\main\\java\\finalProject\\GpaCalculator.java"));
